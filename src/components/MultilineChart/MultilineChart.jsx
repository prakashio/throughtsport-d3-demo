...
const MultilineChart = memo(
  ({ graphData, graphWidth = 800, graphHeight = 400, color = "#F85F73" }) => {
    ...
    useEffect(() => {
      ...
      const tip = d3Tip()
        ...
        .html((d) => {
          ...
          return `<div class="graph-tooltip" style="--primary-color: ${color}">
          <p>${columns[0]} & ${columns[1]}</p>
          <br />
    ...
    return <div className="graph-container" key={graphId} ref={chartRef}></div>;
  }
);
